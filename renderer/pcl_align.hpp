...
void draw_pointcloud(window_util& app, glfw_state& app_state, multiFrame& multiframe)
{
...
void register_glfw_callbacks(window_util& app, glfw_state& app_state, multiFrame& multiframe)
{
